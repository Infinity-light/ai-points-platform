...
describe('TaskStateMachine', () => {
  describe('validateTransition', () => {
    ...
    it('AI_REVIEWING → PENDING_VOTE 合法', () => expect(() => validateTransition(TaskStatus.AI_REVIEWING, TaskStatus.PENDING_VOTE)).not.toThrow());
    it('PENDING_VOTE → SETTLED 合法', () => expect(() => validateTransition(TaskStatus.PENDING_VOTE, TaskStatus.SETTLED)).not.toThrow());
